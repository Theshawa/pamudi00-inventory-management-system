  ...
  <div class="nav_bar">
    ...
    <div class="wrapper">
            ...
            <div class="dropdown">
             ...
             <button id="charge_btn">View Orders</button>
    </div>
    ...
    <div class="view-cards-wrapper">
      ...
      <div class="view-card">
        <table class="card-title-tb">
          <tr>
            <td>
              <h3>New Customer Development Rate</h3>
              <h4>Monthly</h4>
            </td>
          </tr>
        </table>
      ...
      <table class="card-title-tb">
          <tr>
            <td>
              <h3>Customer Retension Rate</h3>
              <h4>Monthly</h4>
            </td>
          </tr>
        </table>
        <h1 style="margin-bottom: 10%;">50%</h1>
      </div>
      <div class="view-card" style="margin-right: 3%;">
        <table class="card-title-tb">
          <tr>
            ...
            <td>
              <h3>Returned Goods Percentage</h3>
              <h4>Monthly</h4>
            </td>
          </tr>
        </table>
...
<script>
    ...
    charge_btn.addEventListener('click', () => {
      location.href = "./owner-view-orders.php";
    });
